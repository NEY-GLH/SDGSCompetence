...
### Fixed
- Fixed issue with by section audits

## [v1.3.4] 2025-02-25

### Fixed
- Fixed issue with nginx not being able to find legacy certificates

## [v1.3.3] 2025-02-25

### Fixed
- Fixed issue viewing audit pages because of new Equivalence users
- Fixed four year emails 
